...
const zipDB = JSON.parse(
  fs.readFileSync(path.join(__dirname, '..', 'contractor-data', 'nj-zipcodes.json'), 'utf8')
);

// Load contractor database
const csvData = fs.readFileSync(
  path.join(__dirname, '..', 'contractor-data', 'all-contractors-nj.csv'), 'utf8'
);
 ...
 */
function matchContractors(homeownerZip, services = [], maxResults = 3, radiusMiles = 40) {
